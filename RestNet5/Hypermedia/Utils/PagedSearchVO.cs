...
namespace RestNet5.Hypermedia.Utils
{
    public class PagedSearchVO<T> where T : ISupportsHypermedia
    {
        ...
        public PagedSearchVO(int currentPage, int pageSize, string sortFields, string sortDirections, Dictionary<string, object> filters, List<T> list)
        {
            CurrentPage = currentPage;
            PageSize = pageSize;
            SortFields = sortFields;
